-- Metro Quebec Price Seed Data (Safe Version)
-- This will only insert prices that don't already exist

-- First, let's check if we should clear existing baseline prices
-- Uncomment the line below if you want to reset price data:
-- DELETE FROM price_data WHERE source = 'metro_baseline';
